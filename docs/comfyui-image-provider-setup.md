...
```bash
useradd --create-home --user-group --shell /bin/bash comfyadmin
install -d -m 700 -o comfyadmin -g comfyadmin /home/comfyadmin/.ssh
printf '%s\n' '<dedicated-public-key>' > /home/comfyadmin/.ssh/authorized_keys
chown comfyadmin:comfyadmin /home/comfyadmin/.ssh/authorized_keys
chmod 600 /home/comfyadmin/.ssh/authorized_keys
...
Log in as `comfyadmin`. Clone the immutable release tag, verify the resolved commit, and create an isolated environment:

```bash
git clone --branch v0.28.2 --depth 1 https://github.com/Comfy-Org/ComfyUI.git /home/comfyadmin/ComfyUI
git -C /home/comfyadmin/ComfyUI rev-parse HEAD

python3 -m venv /home/comfyadmin/ComfyUI/.venv
. /home/comfyadmin/ComfyUI/.venv/bin/activate
python -m pip install --upgrade pip setuptools wheel
python -m pip install \
  torch==2.11.0 torchvision==0.26.0 torchaudio==2.11.0 \
  --index-url https://download.pytorch.org/whl/cu126
python -m pip install -r /home/comfyadmin/ComfyUI/requirements.txt
```
...
```bash
model_dir=/home/comfyadmin/ComfyUI/models/checkpoints
...
/home/comfyadmin/ComfyUI/.venv/bin/python -c \
...
```bash
install -d -o comfyadmin -g comfyadmin -m 0750 \
  /home/comfyadmin/ComfyUI/input \
  /home/comfyadmin/ComfyUI/output \
  /home/comfyadmin/ComfyUI/temp \
  /home/comfyadmin/ComfyUI/user \
  /home/comfyadmin/.cache
```
...
User=comfyadmin
Group=comfyadmin
WorkingDirectory=/home/comfyadmin/ComfyUI
Environment=HOME=/home/comfyadmin
Environment=PYTHONUNBUFFERED=1
Environment=CUDA_DEVICE_ORDER=PCI_BUS_ID
Environment=CUDA_VISIBLE_DEVICES=0
ExecStart=/home/comfyadmin/ComfyUI/.venv/bin/python /home/comfyadmin/ComfyUI/main.py --listen 127.0.0.1 --port 8188 --disable-auto-launch --disable-metadata --disable-all-custom-nodes --disable-api-nodes
Restart=on-failure
RestartSec=5
TimeoutStopSec=30
KillSignal=SIGINT
...
ReadWritePaths=/home/comfyadmin/ComfyUI/input
ReadWritePaths=/home/comfyadmin/ComfyUI/output
ReadWritePaths=/home/comfyadmin/ComfyUI/temp
ReadWritePaths=/home/comfyadmin/ComfyUI/user
ReadWritePaths=/home/comfyadmin/.cache
